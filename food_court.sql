...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 21, 2020 lúc 04:52 PM
...
INSERT INTO `user` (`id`, `username`, `password`, `balance`, `role`, `created_date`) VALUES
(1, 'ngoctrong102', '123', 0, 2, '2020-06-21 00:00:00');
...
--
ALTER TABLE `chief`
  MODIFY `stt_chief` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `order`
  MODIFY `stt_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
